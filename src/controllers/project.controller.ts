...
class Controller {
  ...
  async getAll(req: Request, res: Response) {
    ...
    const data = await projectService.getAll(pagination);
  ...
  async find(req: Request, res: Response) {
    const data = await projectService.find(req.query);
  ...
  async update(req: Request, res: Response) {
    const { id } = req.params;
    const data = await projectService.update({ _id: id }, req.body);
  ...
  async delete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await projectService.softDelete({ _id: id });
  ...
  async hardDelete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await projectService.hardDelete({ _id: id });
