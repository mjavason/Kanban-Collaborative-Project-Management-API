...
class Controller {
  ...
  async getAll(req: Request, res: Response) {
    ...
    const data = await commentService.getAll(pagination);
  ...
  async find(req: Request, res: Response) {
    const data = await commentService.find(req.query);
  ...
  async update(req: Request, res: Response) {
    const { id } = req.params;
    const data = await commentService.update({ _id: id }, req.body);
  ...
  async delete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await commentService.softDelete({ _id: id });
  ...
  async hardDelete(req: Request, res: Response) {
    const { id } = req.params;
    const data = await commentService.hardDelete({ _id: id });
